      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-lg text-slate-600 max-w-3xl mx-auto">
            ...
            Praxiserfahrung und einer gemeinsamen Leidenschaft für
            Bewegung, Gesundheitsförderung und Kinaesthetics.
          </p>
        </div>
            ...
            <div className="p-8 flex-1 flex flex-col justify-between">
              <div>
                ...
                <p className="mt-2 text-emerald-700 font-semibold">
                  Spezialistin für angewandte Kinästhetik <br className="hidden sm:inline" />
